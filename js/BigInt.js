var BigInt = (function(){
	var MAX_DIGIT = 3, MAX_POW = Math.pow(10,MAX_DIGIT);
	...
	BigInt.prototype.dumpData = function(){
		return [this.__sign,copyArr(this.__numberData)];
	}
	BigInt.prototype.clone = function(){return new BigInt([this.__sign,copyArr(this.__numberData)])}
	...
	BigInt.prototype.equals = function(b){
		if((typeof b)=='number'){
	...
	BigInt.prototype.isBiggerThan = function(b){
	...
	BigInt.prototype.setSign = function(s){
		this.__sign = !!s;
	}
	BigInt.prototype.negate = function(){
		this.__sign = !this.__sign;
	}
	BigInt.prototype.addSing = function(i,n){
		if(n==0) return 0;
	...
	BigInt.prototype.sub = BigInt.prototype.subtract = function(b){
		if(b.equals(0)) return this.clone();
		var ts=this.__sign;
		if(this.__sign!=b.__sign){
	...
	BigInt.prototype.mul = BigInt.prototype.multiply = function(b){
	...
	BigInt.prototype.div = BigInt.prototype.divide = function(b){
...
var exports; if(exports) exports.BigInt = BigInt;
